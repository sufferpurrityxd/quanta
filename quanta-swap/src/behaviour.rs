  ...
  S: Storage + 'static,
{
  ...
  fn handle_pending_outbound_connection(
    ...
    self
      .request_response
      .handle_pending_outbound_connection(_connection_id, maybe_peer, _addresses, _effective_role)
  }
  /// Send into [`RequestResponse`]
    ...
    loop {
      ...
      match event {
        Poll::Ready(event) => {
          ...
          if let ToSwarm::GenerateEvent(request_response::Event::Message { peer, message }) = event
          {
            debug!(
